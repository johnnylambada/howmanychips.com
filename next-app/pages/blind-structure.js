    ...
    return (
        <div>
            <div className="input-section">
                ...
                <p>Create a professional blind structure for your home poker game or tournament. Simply enter the number of players, starting chip stack, and desired tournament length.</p>
            </div>
